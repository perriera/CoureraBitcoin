...
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Dogecoin.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Metrics.png)
...
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Step1.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Bob's%20Car(Step2).png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Bob%20&%20Alice%20Gardener(Step3).png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/DMZ.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Protocol.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Bob&Alice.jpg)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/FofX.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Route2.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Route2b.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Route3.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Ethereum.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Route4.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Dispute.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Route5.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Judy.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Markets.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Levels.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Reputation.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Trust.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Generic.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/SmartProperty.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Zerocoin.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Purely.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Colors.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Ownership.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/ComplexContracts.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Auctions.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Matching.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Variant.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/007.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/008.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/010.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/011.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/Exchanges.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/BitcoinSecurity.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/180.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/SPM.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/ABC.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/CrytoAndState.png)
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/TheBigOpportunity.png)
...
![Bitcoin Merkle Tree](https://github.com/perriera/CourseraBitcoin/blob/main/etc/BC001.png)
